...
package com.example.surbhit.seemassign.profile;
...
import com.example.surbhit.seemassign.R;
 ...
 * <p>
 * ExpandableListActivity hosts a {@link ExpandableListView ExpandableListView} object that can be bound to different data sources that provide a
 ...
 * </p>
 * <p>
 * You bind the ExpandableListActivity's ExpandableListView object to data using a class that implements the {@link ExpandableListAdapter
 * ExpandableListAdapter} interface. Android provides two standard list adapters: {@link SimpleExpandableListAdapter SimpleExpandableListAdapter}
 * for static data (Maps), and {@link SimpleCursorTreeAdapter SimpleCursorTreeAdapter} for Cursor query results.
 * </p>
 *
 * @see #setListAdapter
...
public class ExpandableListActivity extends AppCompatActivity implements
	 ...
	 * {@link ExpandableListView.ExpandableListContextMenuInfo} whose packedPosition is a packed position that should be used with
